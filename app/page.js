        ...
        <div className="space-y-8">
          ...
          <div>
            ...
            <div className="space-y-2">
              ...
              <p className="text-justify">
                We develop, provide and sell IT systems and cloud-based services (SaaS) as well as offer support and consulting services within IT, and activities compatible therewith.
              </p>
              <p className="text-justify">
